...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '二凌的小窝', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的干饭人🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://tangly1024.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '技术分享, 经验分享, 博客', // 网站关键词 英文逗号隔开
  ...
  DESCRIPTION:
      process.env.NEXT_PUBLIC_DESCRIPTION || '这是一个用于分享的站点', // 站点描述，被notion中的页面描述覆盖
